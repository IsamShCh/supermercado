...
public class Pago {
    ...
    @Column(name = "IDPago", nullable = false, length = 36)
    ...
    @Column(name = "MontoRecibido", nullable = false, precision = 10, scale = 2)
    ...
    @Column(name = "MontoCambio", nullable = false, precision = 10, scale = 2)
