...
# SECCIÓN 0: EQUIVALENCIAS ENTRE FLUJOS EN LOS DIAGRAMAS
Formulario Datos Catalogo = [ INFO_NUEVO_PRODUCTO | INFO_MODIFICAR_PRODUCTO |  SOLICITUD_DESCATALOGAR | ASIGNACION_ETIQUETAS | INFO_NUEVA_CATEGORIA | INFO_MODIFICAR_CATEGORIA ]
Petición Ajuste Stock = [ INFO_NUEVAS_EXISTENCIAS | INFO_CONTABILIZACION | INFO_AJUSTE_INVENTARIO | INFO_MOVER_STOCK ]
Alertas Stock = [ ALERTA_STOCK_BAJO ]
Alerta Caducidad = [ ALERTA_STOCK_CADUCADO ]
Formulario Inicio Sesión = [ CREDENCIALES_LOGIN | SOLICITUD_LOGOUT | CAMBIO_CONTRASEÑA ]
Token = [ TOKEN_AUTENTICACION ]
Datos Ticket = [ INFO_NUEVO_TICKET ]
Detalles Producto = [ DETALLES_PRODUCTO | LISTA_PRODUCTOS ]
Formulario Venta/Ticket = [ INFO_PAGO | SOLICITUD_CERRAR_TICKET | INFO_AÑADIR_PRODUCTO | INFO_ELIMINAR_PRODUCTO_TICKET | SOLICITUD_NUEVO_TICKET ]
Petición Devolución = [ DATOS_DEVOLUCION ]
Reportes Estratégicos = [ SOLICITUD_REPORTE_CATALOGO | SOLICITUD_REPORTE_VENTAS | SOLICITUD_REPORTE_DEVOLUCIONES ]
Configuración Ofertas = [ INFO_NUEVA_OFERTA ]
Solicitud Reportes = [ REPORTE_CATALOGO | REPORTE_VENTAS ]
Formulario Usuario = [ INFO_NUEVO_USUARIO | INFO_MODIFICAR_USUARIO ]
Configuración Rol = [ INFO_NUEVO_ROL ]
Configuración Seguridad = [ INFO_ASIGNAR_PERMISOS | SOLICITUD_DESACTIVAR ]
Solicitud Informacion Producto = [ CONSULTA_PRODUCTO | CRITERIOS_BUSQUEDA | SOLICITUD_LISTAR_PRODUCTO ]
Consulta Inventario = [ CONSULTA_INVENTARIO ]
Detalles Inventario = [ RESULTADO_CONTABILIZACIÓN | DETALLES_INVENTARIO ]
Nuevo Proveedor = [ INFO_NUEVO_PROVEEDOR ]
